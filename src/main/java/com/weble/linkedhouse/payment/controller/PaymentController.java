...
public class PaymentController {
    ...
    public List<PaymentResponseDto> findByCustomerId(@RequestParam Long customerId) {
        return paymentService.findByCustomerId(customerId);
    }

    @PostMapping("/{rentalId}") // 결제
    public void savePayment(@AuthenticationPrincipal UserDetailsImpl userDetails, @RequestPart PaymentRequestDto paymentRequestDto, @PathVariable Long rentalId) {
